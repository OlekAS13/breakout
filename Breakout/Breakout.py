...
while running:
    ...
    # tekst gracza
    playerText = atari.render("{}".format(whichPlayer), True, [204, 204, 204])

    
    # miejsce setne punktow
    pointsHundered = atari.render("{}".format(pointsP1 // 100), True, [204, 204, 204])
    
    # miejsce dziesiate punktow
    pointsTen = atari.render("{}".format((pointsP1 // 10) % 10), True, [204, 204, 204])
    
    # miejsce jednosci punktow
    pointsOne = atari.render("{}".format(pointsP1 % 10), True, [204, 204, 204])
        
    # tekst ilosci straconych pilek
    if whichPlayer == 1:
        lostBallsText = atari.render("{}".format(lostBallsP1), True, [204, 204, 204])
    
    elif whichPlayer == 2:
        lostBallsText = atari.render("{}".format(lostBallsP2), True, [204, 204, 204])
    
    # punkty drugiego gracza
    secPointsHundered = atari.render("{}".format(pointsP2 // 100), True, [204, 204, 204])
    secPointsTen = atari.render("{}".format((pointsP2 // 10) % 10), True, [204, 204, 204])
    secPointsOne = atari.render("{}".format(pointsP2 % 10), True, [204, 204, 204])
